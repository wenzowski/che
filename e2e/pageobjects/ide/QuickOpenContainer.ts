...
export class QuickOpenContainer {
    ...
    public async waitContainer(timeout = TestConstants.TS_SELENIUM_DEFAULT_TIMEOUT) {
    ...
    public async clickOnContainerItem(itemText: string, timeout = TestConstants.TS_SELENIUM_DEFAULT_TIMEOUT) {
