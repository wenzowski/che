...
export class GitHubPlugin {
    ...
    async openGitHubPluginContainer(timeout = TestConstants.TS_SELENIUM_DEFAULT_TIMEOUT) {
    ...
    async waitGitHubContainer(timeout = TestConstants.TS_SELENIUM_DEFAULT_TIMEOUT) {
